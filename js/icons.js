...
const PATHS = {
  ...
  'fish':           '<path d="M6.5 12c.94-3.46 4.94-6 8.5-6 3.56 0 6.06 2.54 7 6-.94 3.47-3.44 6-7 6s-7.56-2.53-8.5-6Z"/><path d="M18 12v.5"/><path d="M16 17.93a9.77 9.77 0 0 1 0-11.86"/><path d="M7 10.67C7 8 5.58 5.97 2.73 5.5c-1 1.5-1 5 .23 6.5-1.24 1.5-1.24 5-.23 6.5C5.58 18.03 7 16 7 13.33"/><path d="M10.46 7.26C10.2 5.88 9.17 4.24 8 3h5.8a2 2 0 0 1 1.98 1.67l.23 1.4"/><path d="M16.01 17.93l.23 1.4A2 2 0 0 1 14.26 21H8.46c1.16-1.24 2.2-2.88 2.46-4.26"/>',
  ...
  'beer':           '<path d="M17 11h1a3 3 0 0 1 0 6h-1"/><path d="M9 12v6"/><path d="M13 12v6"/><path d="M14 7.5c-1 0-1.44.5-3 .5s-2-.5-3-.5-1.72.5-2.5.5a2.5 2.5 0 0 1 0-5c.78 0 1.57.5 2.5.5S9.44 3 11 3s2 .5 3 .5 1.72-.5 2.5-.5a2.5 2.5 0 0 1 0 5c-.78 0-1.5-.5-2.5-.5Z"/><path d="M5 8v10a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V8"/>',
...
export const CAT_ICON_CHOICES = [
  'coffee', 'martini', 'wine', 'beer', 'music', 'mic',
  'utensils', 'utensils-crossed', 'soup', 'fish', 'salad', 'pizza',
  'drumstick', 'croissant', 'cake', 'ice-cream', 'flame', 'leaf',
  'building', 'home', 'heart', 'paw', 'star', 'sparkles',
  'sun', 'moon', 'camera', 'instagram', 'dollar', 'compass',
  'globe', 'trophy', 'map-pin',
];
